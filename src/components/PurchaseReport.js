...
const PurchaseReport = () => {
    ...
    useEffect(() => {
        fetch('https://puzzled-colt-kimono.cyclic.app/api/purchase/getallpurchase')
    ...
    const handleModal = async (id) => {
        // await fetch(`https://puzzled-colt-kimono.cyclic.app/api/product/getproductbypurchaseid/${id}`)
        //     .then(response => response.json())
        //     .then(data => {
        ...
        //     });
        const uri = `https://puzzled-colt-kimono.cyclic.app/api/product/getproductbypurchaseid/${id}`;
