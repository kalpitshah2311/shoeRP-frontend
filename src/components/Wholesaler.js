...
const Wholesaler = ({ showAlert }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const url = 'https://puzzled-colt-kimono.cyclic.app/api/wholesaler/addwholesaler';
        const data = {
    ...
    const getAllWholesaler = async () => {
        const url = 'https://puzzled-colt-kimono.cyclic.app/api/wholesaler/getallwholesaler';
        const response = await fetch(url);
        const result = await response.json();
